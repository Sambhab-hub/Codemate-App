 ...
 * All icons are from Heroicons (MIT license) with strokeWidth 1.5.
 *
 * Usage: import { HomeIcon, FolderIcon } from '../ui/Icons';
...
export const PullRequestIcon = ({ className = 'w-5 h-5' }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
export const BugIcon = ({ className = 'w-5 h-5' }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 12.75c1.148 0 2.278.08 3.383.237 1.037.146 1.866.966 1.866 2.013 0 3.728-2.35 6.75-5.25 6.75S6.75 18.728 6.75 15c0-1.046.83-1.867 1.866-2.013A24.204 24.204 0 0 1 12 12.75Zm0 0c2.883 0 5.647.508 8.207 1.44a23.91 23.91 0 0 1-1.152 6.06M12 12.75c-2.883 0-5.647.508-8.208 1.44a23.916 23.916 0 0 0 1.152 6.061M12 12.75V4.5m8.207 8.69c.78.294 1.536.62 2.275.97M3.518 13.19a22.908 22.908 0 0 0-2.275.97M6.75 4.5l2.08 2.08M17.25 4.5l-2.08 2.08M12 4.5 9.75 2.25M12 4.5l2.25-2.25" />
  </svg>
);

export const IssueIcon = ({ className = 'w-5 h-5' }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
